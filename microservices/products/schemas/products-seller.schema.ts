...
export class ProductsSeller {
  ...
  // Resueltos contra las tablas marca/familia/subfamilia del ERP — marca por
  // similitud (texto libre), categoria/subcategoria por nombre exacto (vienen
  // de un desplegable en el Excel). Nullable hasta resolverse (automático o
  // corrección manual del admin en el CMS).
