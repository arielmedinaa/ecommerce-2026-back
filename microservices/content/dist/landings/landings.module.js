    ...
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([
                { name: landings_schemas_1.Landing.name, schema: landings_schemas_1.LandingSchema },
                { name: formatos_schema_1.Formato.name, schema: formatos_schema_1.FormatoSchema },
                { name: landings_error_schema_1.LandingError.name, schema: landings_error_schema_1.LandingErrorSchema },
            ])
        ],
